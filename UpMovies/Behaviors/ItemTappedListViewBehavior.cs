...
namespace UpMovies.Behaviors
{
    // Simple way to define what to do on List Item when It's tapped by the user (To respect MVVM pattern)
    public static class ItemTappedListViewBehavior
    {
